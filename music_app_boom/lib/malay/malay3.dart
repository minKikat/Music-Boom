...
class Malay3 extends StatefulWidget {
  Malay3({super.key});

  final FirestoreService firestoreService = FirestoreService();

  @override
  Malay3State createState() => Malay3State();
}

class Malay3State extends State<Malay3> {
  bool isPlaying = true;
  late AudioPlayer audioPlayer;
  bool isFavourite = false;
  final Logger _logger = Logger('Malay3State');

  final String songName = 'Gurindam Jiwa';
  final String artistName = 'Dayang Nurfaizah, Hael Husaini';
  ...
  void initState() {
    ...
    context
        ...
        .loadLocalSong('assets/audio/malay/Gurindam Jiwa.mp3');
  ...
  Future<void> _loadLocalAsset() async {
    ...
    try {
      await audioPlayer.setAsset('assets/audio/malay/Gurindam Jiwa.mp3');
    } catch (e) {
